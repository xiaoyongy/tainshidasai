"""
详解cycleGAN（生成对抗网络）代码   https://blog.csdn.net/weixin_40548136/article/details/86014596#modelpy_89
cyclegan代码学习   https://www.jianshu.com/p/ea4b21f8c6e0
"""
...
class CycleGAN():
    ...
    def input_setup(self):
        ...
        filenames_A = tf.train.match_filenames_once("G:/dataset/apple2orange/trainA/*.jpg")
        self.queue_length_A = tf.size(filenames_A)
        filenames_B = tf.train.match_filenames_once("G:/dataset/apple2orange/trainB/*.jpg")
